...
var myWindow = window.open("createAccount.html", "_self");
}
...
<form method="POST" action="login.php">
    ...
    <div class="inner-wrap">
        <label>Username <input type="text" name="op1" /></label>
		<label>Password <input type="password" name="op2" /></label>
        
    </div>

    <div class="button-section">
	<input type="checkbox" name="agent" value="ag">login as tour and travel agent.<br/>
     <input type="submit" name="login" /> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
	       
	 <input type="button" value="Create account" onclick="direct()">

...
<p><a href="#" class="dropbtn"><i class="fa fa-book"></i>TOURIST INFO</a></p>
  ...
  <iframe src="http://localhost/ethioTourism.com/display.html" width="18%" height="1500px"
                
                marginwidth="10" marginheight="10"  align ="left">
				
       </iframe>
			  
			  <iframe src="http://localhost/ethioTourism.com/place/Bd.html" width="70%" height="1000px"
                 align ="right" name="ifr"  
                 >
           </iframe>
